...
echo "ApplicationStart: Iniciando a aplicação" | tee -a /home/ec2-user/IngestData-App/deploy.log

# Adicionar ~/.local/bin ao PATH
export PATH=$PATH:/home/ec2-user/.local/bin
echo "PATH atualizado: $PATH" | tee -a /home/ec2-user/IngestData-App/deploy.log
...
echo "Verificando se o uvicorn está no PATH" | tee -a /home/ec2-user/IngestData-App/deploy.log
which uvicorn | tee -a /home/ec2-user/IngestData-App/deploy.log
